...
# cs481-S2019-lab1-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Lab 1 in Computer Science 481. Since the
...
features the `report.md` files that contains an assessment of the work that you
completed for this long-term software project and a report that further
documents your work. Importantly, the purpose of this repository is only to
document and evaluate the work that you complete in the
[GatorGrader](https://github.com/GatorEducator/gatorgrader) repository. Students
who do not understand how to copy-over or fill-in these files should speak with
the course instructor. Please refer to the `report.md` file for additional
details about how to report on and evaluate your work.
...
```
git remote add download git@github.com:Allegheny-Computer-Science-481-S2019/cs481-S2019-lab1-starter.git
```
...
you can go to the [Computer Science 481 Lab 2
Starter](https://github.com/Allegheny-Computer-Science-481-S2019/cs481-S2019-lab1-starter)
...
[cs481-S2019-sheets](https://github.com/Allegheny-Computer-Science-481-S2019/cs481-S2019-sheets)
